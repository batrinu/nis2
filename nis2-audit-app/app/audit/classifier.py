"""
Entity Classifier for NIS2 compliance assessment.
Ported from the core agents/entity_classifier for the Field Audit App.
"""
import logging
...
from ..models.entity import EntityInput, EntityClassification, SizeDetails, CrossBorderInfo
from .knowledge_base import NIS2KnowledgeBase
